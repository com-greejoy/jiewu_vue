...
//        openId = "op3oK7doMbiZPD2QyiXwyWtPDTLg";
    ...
    @ResponseBody
    public AjaxResult getWxSportListWithGameItem(@RequestHeader("Authorization") String openId, Long gameItemId, Long editId){
        JwWxUser zwWxUser = jwWxUserService.selectZwWxUserByOpenId(openId);
        if(zwWxUser != null){
            ...
            List<JwSport> jwSportList = jwSportService.getWxSportListWithGameItem(zwWxUser.getId(), gameItemId, minAge, maxAge, sex);
